...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/fondo_300x250.jpg?1478014659565", id:"fondo_300x250"},
		{src:"images/FrameBgEnd.jpg?1478014659565", id:"FrameBgEnd"},
		{src:"images/N1.png?1478014659565", id:"N1"},
		{src:"images/tarima.png?1478014659565", id:"tarima"},
		{src:"images/thisNov8SausageParty.png?1478014659565", id:"thisNov8SausageParty"},
		{src:"images/VoteForBagel_bagelSammy.png?1478014659565", id:"VoteForBagel_bagelSammy"},
		{src:"images/VoteForChillary.png?1478014659565", id:"VoteForChillary"},
		{src:"images/VoteForHotDogBum_Brenda.png?1478014659565", id:"VoteForHotDogBum_Brenda"},
		{src:"images/VoteForLavasha.png?1478014659565", id:"VoteForLavasha"},
		{src:"images/VoteForSausage.png?1478014659565", id:"VoteForSausage"},
		{src:"images/VoteForTaco_teresa.png?1478014659565", id:"VoteForTaco_teresa"},
		{src:"images/VoteForTrumpkinpngcopy.png?1478014659565", id:"VoteForTrumpkinpngcopy"}
	]
};
...
(lib.thisNov8SausageParty = function() {
	this.initialize(img.thisNov8SausageParty);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,300,250);
...
(lib.txt_Sausage = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.thisNov8SausageParty();
...
(lib._09_TeresaVsTrumpkin = function(mode,startPosition,loop) {
	...
	this.instance_3.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
...
(lib.SausageParty_300x250_StartTrumpkinV5 = function(mode,startPosition,loop) {
	...
	this.btn_buy.setTransform(65,233.2,1.987,1);
	...
	// 16
	this.instance_9 = new lib._102_ResultsChillary();
	...
	// 11_ResultsTrumpkin
	this.instance_19 = new lib._101_ResultsTrumpkin();
	...
	this.btn_VoteForLavashTWO.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForTeresaTWO.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForSammyBagelJrTWO.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForBrendaTWO.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForFrankTWO.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	// 06_FrankVsChillary
	this.instance_31 = new lib._06_FrankVsChillary();
	...
	this.btn_VoteForLavashONE.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForTeresaONE.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForSammyBagelJrONE.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForBrendaONE.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	this.btn_VoteForFrankONEroto.setTransform(74.3,-27,1.016,1.387,0,0,0,221.2,164.1);
	...
	// 01_FrankVsTrumpkin
	this.instance_41 = new lib._01_FrankVsTrumpkin();
	this.instance_41.setTransform(150,125,1,1,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_41).to({_off:true},7).wait(218));
